...
# Code
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def backtest_lstm(df_train, df_test, df_true, sample_size,
    ...
    for name_station in df_train.keys():
        try:
            # START THE LOOP
            # ===================================
            ...
            # DATA EXTRACTION
            # ===================================
            df_train = df_train[name_station].copy()    
            df_test = df_test[name_station].copy()      
            df_true = df_true[name_station].copy()
    ...
    return df_test, mape_results, all_losses
